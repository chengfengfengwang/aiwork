...
const openInxxYYJ  = window.navigator.userAgent.indexOf('com.immusician.children')!=-1;
//校园版
const openInXYB  = window.navigator.userAgent.indexOf('com.immusician.campus')!=-1;
export { openApp, dateCount,formatNumber, toPayString, getQueryVariable, testPlat, formatTime, setRem, isIphonex, openInxxYYJ, openInXYB }