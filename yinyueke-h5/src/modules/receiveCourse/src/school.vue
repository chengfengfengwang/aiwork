<template>
  ...
  <div id="home">
    <div class="logo">
      <img src="./../../../assets/img/receiveCourse/school/logo.png" alt>
    </div>
    <div class="page_title">
      <img src="./../../../assets/img/receiveCourse/school/page_title.png" alt>
    </div>
    <div class="welcome">
      <div class="fl">
        欢迎
        <span style="color: #bf3636;">{{schoolName}}</span>的家长
      </div>
    ...
    <div class="box1">
      ...
      <div class="item2">提交成功后点击下载APP按钮，安装成功后即可登录上课；如您已安装音乐壳校园版会自动启动APP。</div>
    </div>
    <div class="box2">
      <div class="box_title">
      ...
      <div class="input_wrapper phone">
        ...
        <div v-show="phoneErrorShow" class="error">手机号不正确</div>
      </div>
      <div class="item_title">密码</div>
      <div class="input_wrapper password">
        <input v-model="password" type="password" placeholder="设置6-16位数字或字母组合密码">
        <div v-show="passwordErrorShow" class="error">密码强度不符合要求</div>
      </div>
      <div class="item_title grade">选择年级</div>
      <div class="grade_type">（小学）</div>
...
export default {
  ...
  methods: {
    ...
    toActive() {
      ...
      var param = {
        ...
        extra_info: {
          ...
          grade: this.gradeHans[this.gradeAcIndex] + "年级",
          class: this.classInfo + "班"
        }
      };
      console.log(param);
      //return
      ...
      this.axios
        .post(
          `http://api.school.immusician.com/v2/channel_active_course`,
          param
        )
        .then(res => {
    ...
    changeBtn() {
      var arr = ["phone", "nickname", "password", "gradeAcIndex", "classInfo"];
...
#home {
  ...
  background: url("./../../../assets/img/receiveCourse/school/bg.png") no-repeat
    center;
