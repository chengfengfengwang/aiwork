...
export default {
  ...
  mounted() {
    var dicArr = [
      '巴西音乐-Fly Me To The Moon',
      '巴西音乐-Desafinado',
      '巴西音乐-A Felicidade',
      '巴西音乐-Manha de Carnava',
      '中国音乐-牧童短笛',
      '中国音乐-彩云追月',
      '中国音乐-保卫黄河',
      '美国夏威夷音乐-You Are My Sunshine',
      '美国夏威夷音乐-Over The Rainbow',
      '美国夏威夷音乐-Summer Rain',
      '美国夏威夷音乐-Chupee',
      '非洲音乐-Djole',
      '非洲音乐-Abondand',
    ...
    $(document).ready(function($) {
      ...
      $(".list li").click(function(event) {
        ...
        location.href = `wordSongList.html?s=${index + 1}&title=${title}#/play`;
        return;
