<template>
  <div id="instrumentWrapper">
    <img
      v-show="status=='pause'"
      @click="play"
      src="../../../assets/img/wordSongList/folkplay.jpg"
      alt
      class="play"
    >
    <img
      ...
      @click="pause"
      src="../../../assets/img/wordSongList/folkpause.jpg"
      alt
      class="pause"
    >
...
export default {
  ...
  created() {
    ...
    var src = baseUrl + this.audioIndex +'.'+ getQueryVariable("title") +'.mp3';
...
#instrumentWrapper {
  position: relative;
  min-height: 100vh;
  background: url("../../../assets/img/wordSongList/folkbg.png") no-repeat center
    top/cover;
  overflow: hidden;
  .play,
  .pause {
