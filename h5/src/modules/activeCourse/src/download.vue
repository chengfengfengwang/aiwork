<template>
  <div id="main">
    <div class="main_wrapper">
      <img class="bg" src="../../../assets/img/activeCourse/download.png" alt />
      <!-- <img class="bottom" src="../../../assets/img/yiqiac/download_bottom.png" alt=""> -->
      <div @click="download" id="download">
        立即下载
        <!-- <a style="color:#fff" href="https://a.app.qq.com/o/simple.jsp?pkgname=com.immusician.organization">立即下载</a> -->
      </div>
    </div>
...
export default {
  ...
  methods: {
    download(){
      location.href = 'https://a.app.qq.com/o/simple.jsp?pkgname=com.immusician.organization'
    },
    initShareInstall() {
