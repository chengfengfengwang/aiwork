  ...
  <div id="main">
    ...
    <div class="record">
      ...
      <div class="rule_item">
        ...
        <span>你邀请的首个好友注册后，系统自动随机奖励你2-5元现金。</span>
      </div>
      <div class="rule_item">
        <div class="item_index">2</div>
        <span>你邀请的好友付费且7天内未退费。好友购课实付金额的20%，是你获得的现金奖励。</span>
      </div>
      <div class="rule_item">
        <div class="item_index">3</div>
        <span>会员邀请的新用户，每月月初起最先下单的2个新用户，可享受300元优惠购买音乐壳会员。</span>
      </div>
      <div class="rule_item">
      ...
      <div class="rule_item">
        ...
        <span>你获得的现金奖励，大于50元时可申请提现。如不够50元，可顺延到下次申请。</span>
      </div>
      <div class="rule_item">
