  ...
  <div class="page">
    <div class="top">
      ...
      <div class="share" @click="share" v-show="openInApp">
        <img src="../../../assets/img/learnReport/share.png" alt>
        <span>分享</span>
      </div>
      <div class="org_info">
        <div>
          恭喜
          <span class="user_name">{{reportInfo.nickname}}</span> 宝贝
        </div>
        <div>
          在
          <span class="org_name">{{reportInfo.institutions_name}}</span> 完成新一课学习
        </div>
      </div>
      <div class="lesson">{{reportInfo.lesson_name_num}} {{reportInfo.lesson_name}}</div>
      <div class="learn_time">学习时间 {{learnTime.date}} {{learnTime.startTime}}-{{learnTime.endTime}}</div>
    </div>
    <div class="bottom">
      <div class="person_box">
        <div class="new_avator">
          <img src="../../../assets/img/learnReport/a_bottom.png" alt class="a_bottom">
          <img src="../../../assets/img/learnReport/a_left.png" alt class="a_left">
          <img src="../../../assets/img/learnReport/a_right.png" alt class="a_right">
          <!-- <img src="../../../assets/img/learnReport/a_outline.jpg" alt class="out_line"> -->
          <img :src="reportInfo.avatar" alt class="a_main">
          <span class="user_title">{{reportInfo.title}}</span>
        </div>
        <img src="../../../assets/img/learnReport/person_box.jpg" alt class="person_box_bg">
        <div class="person_box_content">
          <div class="name">{{reportInfo.nickname}}小朋友</div>
          <div class="learn_detail">
            <div class="left">
              <div class="common_text">在音乐壳坚持学习</div>
              <div>
                <span class="day_num">{{reportInfo.day}}</span>
                <span class="day">天</span>
              </div>
            </div>
            <div class="right">
              <div class="common_text">已经超过同学</div>
              <div class="person">{{reportInfo.random}}%</div>
            </div>
          </div>
        </div>
      </div>
      <div class="box performance" v-if="showCanvas">
        <div class="title_img">
          <span class="text">课堂表现</span>
          <img src="../../../assets/img/learnReport/class_note1.jpg" alt>
        </div>
      ...
      <div class="box k_points" v-if="knowledgePoints.length>0">
        ...
        <div class="title_img">
          ...
          <img src="../../../assets/img/learnReport/class_note2.jpg" alt>
        </div>
        <div class="ring_box">
          ...
          <div v-for="(point,index) in knowledgePoints" :key="index" class="point" :class="['point'+(index+1)]">{{point}}</div>
          <div class="ring ring1"></div>
          <div class="ring ring2"></div>
          <div class="ring ring3"></div>
          <img src="../../../assets/img/learnReport/coco.png" alt class="coco">
        </div>
      </div>
      <div class="box homework">
        ...
        <div class="homework_content">
          ...
          <p v-show="reportInfo.class_video!=''">
            完成<span style="color:#FF742A">{{reportInfo.lesson_name_num}}</span>随堂视频
      ...
      <div class="box road">
        <div class="title_img">
          <span class="text">成长之路</span>
          <img src="../../../assets/img/learnReport/class_note2.jpg" alt>
        </div>
        <div>
          <p>本学期累计认真听讲</p>
          <p class="value">
            <span class="num">{{totalMinuts}}</span>分钟
          </p>
          <p>本学期累计学习知识点</p>
          <p class="value">
            <span class="num">{{reportInfo.total_point_num}}</span>个
          </p>
        </div>
      </div>
      <div class="footer">
        <img src="../../../assets/img/learnReport/footer_wave.png" alt="">
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    knowledgePoints(){
      if(this.reportInfo.institution_knowledge_list){
        return this.reportInfo.institution_knowledge_list
      }else{
        return[]
      }
    }
  ...
  methods: {
    ...
    formatCanvasData() {
      if (this.reportInfo && this.reportInfo.stars_list) {
        const sourceData = this.reportInfo.stars_list;
        this.echartsData = sourceData.map(e => Number(e.num));
    ...
    getReport() {
      ...
      this.axios
        .get(
          `${
            process.env.VUE_APP_ORG
          }/v9/students/report?course_id=${courseId}&lesson_id=${lessonId}`,
          {
            headers: {
        ...
        .then(res => {
          ...
          if(this.reportInfo.stars_list && this.reportInfo.stars_list.length>0){
...
.top {
  ...
  height: 300px;
  background: url("./../../../assets/img/learnReport/top_bg.png") no-repeat
    center/cover;
  .logo {
    position: absolute;
    left: 20px;
  ...
  .org_info {
    ...
    padding-top: 10px;
    height: 66px;
    background: url("./../../../assets/img/learnReport/org_info.png") no-repeat
      center/cover;
    text-align: center;
    font-size: 16px;
    font-family: PingFang-SC-Regular, PingFang-SC;
    font-weight: 400;
    color: rgba(161, 88, 7, 1);
    .user_name,
    .org_name {
      color: #a15807;
  ...
  .learn_time {
    padding: 3px 0;
    background: url(../../../assets/img/learnReport/learn_time.png) no-repeat
      center/240px 30px;
    text-align: center;
    font-size: 14px;
    font-family: PingFang-SC-Regular, PingFang-SC;
...
.bottom {
  background-color: #3ec751;
  .person_box {
    position: relative;
    margin: 0 auto 15px auto;
    width: 365px;
    height: 210px;
    //background: url('../../../assets/img/learnReport/person_box.jpg') no-repeat center/cover;
    .person_box_bg {
      position: absolute;
      left: 0;
      top: 0;
  ...
  .box {
    ...
    .title_img {
      ...
      font-weight: 600;
      color: rgba(255, 255, 255, 1);
      //background: url(../../../assets/img/learnReport/class_note1.jpg) no-repeat center/cover;
      .text {
        position: relative;
        z-index: 2;
        //margin-top:10px;
