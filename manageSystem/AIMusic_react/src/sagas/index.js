...
function *initApp() {
    ...
    try {
        ...
        let pianoTuningMethods = yield call(api.getTuningMethods, 'piano');
        let harmonicaTuningMethods = yield call(api.getTuningMethods, 'harmonica');

        yield put(actions.updateTuningMethods({guitar: guitarTuningMethods, ukulele: ukuleleTuningMethods, kalimba: kalimbaTuningMethods, djembe:djembeTuningMethods, piano:pianoTuningMethods, harmonica:harmonicaTuningMethods}));
        yield put(actions.hideWaiting());
    } catch (error) {
        yield put(actions.hideWaiting());
        yield put(actions.showError(error));
