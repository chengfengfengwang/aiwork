...
export function getViewableFields({type, includeVoices, simple = false}) {
    ...
    switch (type) {
        ...
        case 'recommend_detail':
            ...
            break;
        case 'gameGuide':
            fields = _.pick(fields, ['guideType', 'guideAudio']);
            break;
        default:
            break;
    }
...
export function getEditableFields({type, includeAssignment = false}) {
    let fields = _.cloneDeep(materialFields);
    let commonFields = ['id', 'name', 'type', 'user', 'instrumentType', 'createdAt', 'updatedAt', 'isOfficial', 'property'];
    if (includeAssignment) {
        commonFields.push('highlight');
        commonFields.push('state');
    }
    switch (type) {
        case 'video':
            fields = _.pick(fields, [...commonFields, 'videoUrl']);
            break;
        case 'audio':
            fields = _.pick(fields, [...commonFields, 'audioUrl', 'coverUrl']);
            break;
        ...
        case 'chordGroup':
            ...
            fields = _.pick(fields, [...commonFields,  'tuningFret', 'tuningTo', 'tuningMethod', 'metronomeIndex', 'numerator', 'denominator', 'tapTempo', 'chordPass', 'repeat','showChard']);
            break;
        case 'newChordGroup':
            fields = _.pick(fields, [...commonFields, 'chords', 'tuningFret', 'tuningTo', 'tuningMethod', 'metronomeIndex', 'numerator', 'denominator', 'tapTempo', 'chordPass', 'repeat','showChard', 'describe']);
            break;
        ...
        case 'blueteeth':
            ...
            break;
        case 'choiceGroup':
            fields = _.pick(fields, [...commonFields, 'choiceIds', 'limitType', 'limitTime', 'hasBgt','bgtUrl', 'tipAudioUrl']);
            // fields = _.pick(fields, [...commonFields, 'choiceIds', 'limitType', 'limitTime', 'hasBgt','bgtUrl']);
            break;
        case 'choice':
            fields = _.pick(fields, [...commonFields, 'limitTime', 'tryTime', 'hasNext', 'choiceTitle', 'choiceScore',  'choiceType']);
            break;
        case 'expandInfo':
            fields = _.pick(fields, [...commonFields, 'extendInfoArr']);
            break;
        case 1:
            fields = _.pick(fields, [...commonFields,'limitTime', 'tryTime', 'hasNext', 'choiceTitle', 'choiceTitleUrl', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers', 'item']);
            break;
        case 2:
            fields = _.pick(fields, [...commonFields,'limitTime', 'tryTime', 'hasNext', 'choiceTitle','choiceTitleUrl', 'choiceTxt', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers', 'item', 'choiceUrl1','choiceUrl2','choiceUrl3','choiceUrl4']);
            break;
        case 3:
            fields = _.pick(fields, [...commonFields,'limitTime', 'tryTime', 'hasNext', 'choiceTitle', 'choiceScore','choiceTitleUrl', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers', 'item', 'choiceUrl1','choiceUrl2','choiceUrl3','choiceUrl4']);
            break;
        case 4:
            fields = _.pick(fields, [...commonFields,'limitTime', 'tryTime', 'hasNext', 'choiceScore', 'choiceTitleUrl', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers']);
            break;
        case 5:
            fields = _.pick(fields, [...commonFields,'limitTime', 'tryTime', 'hasNext', 'choiceScore', 'choiceTitleUrl', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers']);
            break;
        case 'title_url':
            fields = _.pick(fields, [...commonFields, 'choiceTitleUrl']);
            break;
        case 6:
            fields = _.pick(fields, [...commonFields, 'limitTime', 'tryTime', 'hasNext','choiceTitle', 'choiceScore','choiceTitleUrl', 'choiceType', 'fromBgt', 'index','isUniterming', 'answerType','rightAnswers', 'item', 'choiceUrl1','choiceUrl2','choiceUrl3','choiceUrl4']);
            break;
        case 'gameGuide':
            fields = _.pick(fields, [...commonFields, 'guideType', 'guideAudio']);
            break;
        default:
            fields = {};
