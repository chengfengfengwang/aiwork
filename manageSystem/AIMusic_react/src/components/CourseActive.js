                            ...
                            <Form horizontal>
                                ...
                                <FormGroup>
                                    ...
                                    <Col sm={10}>
                                        ...
                                        <Button onClick={() => this.increase('expirationTime', purchase.expirationTime)}>加一天</Button>
                                        <Button onClick={() => this.decrease('expirationTime', purchase.expirationTime)}>减一天</Button>
                                        <Button onClick={() => this.increasem('expirationTime', purchase.expirationTime)}>加一月</Button>
                                        <Button onClick={() => this.decreasem('expirationTime', purchase.expirationTime)}>减一月</Button>
                                        <Button onClick={() => this.increasey('expirationTime', purchase.expirationTime)}>加一年</Button>
                                        <Button onClick={() => this.decreasey('expirationTime', purchase.expirationTime)}>减一年</Button>
                                    </Col>
                                </FormGroup>
                            </Form> : null
                    }
                ...
                <Row>
                    <Col sm={8}>
                        <Form inline style={{padding: 3}}>
                            ...
                            &nbsp;
                            <FormControl bsSize="sm" placeholder="激活逗号分隔的课程id" style={{width: '150px', border: 'solid 1px red'}} value={courseIds} onChange={e => {
                                this.setState({courseIds: e.target.value.trim()})
                            }}/>
                            &nbsp;
                            <Button
                                onClick={(e) => {
                            ...
                            <Button
                                onClick={(e) => {
                                    e.preventDefault();
                                    this.onActive(false, true)
                                }}
                                bsSize="sm" bsStyle="success">激活所有进阶</Button>
                            &nbsp;
                            <Button
                                onClick={(e) => {
                                    e.preventDefault();
                            ...
                            <Button
                                ...
                                bsSize="sm" bsStyle="danger">激活附送进阶</Button>
                            <Button
                                onClick={(e) => {
                                    e.preventDefault();
