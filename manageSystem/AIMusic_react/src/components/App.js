...
import ConfigsImport from "./ConfigsImport";
import ConfigsFront from "./ConfigsFront"
const One = () => <h3>One</h3>;
const Two = () => <h3>Two</h3>;
                            ...
                            <Row style={{marginRight: 0}}>
                                ...
                                <Col sm={10}>
                                    <Switch>
                                        ...
                                        <Route path="/active_code" component={ActiveDetail}/>
                                        <Route path="/menuActivity" component={MenuActivity}/>
                                        <Route path="/configsImport" component={ConfigsImport}/>
                                        <Route path="/configsFront" component={ConfigsFront}/>
                                    </Switch>
                                </Col>
                            </Row>
                        </div>
