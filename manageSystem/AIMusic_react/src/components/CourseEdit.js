...
export default class CourseEdit extends Component {
    ...
    onLessonChange({key, value}) {
        ...
        if(key === 'pieceVUrl'){
            ...
            lesson.pieceVUrl = pieceVUrlValue;
                                ...
                                <Form horizontal>
                                    {
                                        lessonFields.map(([key, field], index) => {
                                            ...
                                            if ((key === 'property' || key === 'extendInfoArr' || key === 'videoArr' || key === 'offArr' || key === 'voiceArr' || key === 'durArr' || key === 'recommendV2') && activeLesson[key] instanceof Object) {
