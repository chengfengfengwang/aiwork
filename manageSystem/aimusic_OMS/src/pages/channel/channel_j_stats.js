...
export default class FeeTableStats extends React.Component {
    ...
    state = {
        day: moment().add(-1, 'days').format('YYYY-MM-DD'), begin_date: moment(moment().year() + '-' + config.formatNumber((moment().month() + 1))).format('YYYY-MM-DD'),
        ...
        fee_channel_data_columns: [
            {title: '渠道名称', dataIndex: 'type', key: 'type', width: 150,},
            {
            ...
            },
            {
                ...
                sorter: (a, b) => a.order_count - b.order_count, defaultSortOrder: 'descend',width: 150,
            },
            {
                title: '付费金额', dataIndex: 'amount', key: 'amount',
    ...
    get_total_data({
        ...
        if (type === 'channel') {
            ...
            fetch(this.main_host + `/v3/channel/date_j_channel/`
                    ...
                    <Col span={24}>
                        ...
                        >
                            <Table dataSource={fee_channel_data_list} loading={loading_1} bordered
                                   pagination={paginationProps} scroll={{ y: 600 }}
