...
export default class FeeTableStats extends React.Component {
    ...
    componentDidMount() {
        ...
        this.get_total_data({type:'course'});
        this.get_total_data({type:'payment'});
    }
    ...
    render() {
        const {
            fee_total_data_columns, choose_channels, loading_1, loading_2,
                ...
                <Row style={{marginTop: '50px'}}>
                    <Col span={24}>
                        <Card
                            ...
                            hoverable={true}
                        >
                            <Table dataSource={fee_channel_data_list} loading={loading_1}
                ...
                <Row style={{marginTop: '10px'}}>
                    <Col span={24}>
                        <Card
                            ...
                            hoverable={true}
                        >
                            <Table dataSource={fee_platform_data_list} loading={loading_2}
                                   className={styles.customTable}
                                   columns={fee_total_data_columns} size="small"/>
                        </Card>
                    </Col>
