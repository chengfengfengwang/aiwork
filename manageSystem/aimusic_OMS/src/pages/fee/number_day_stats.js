...
export default class NumberDayStats extends React.Component {
    main_host = config.debug ? config.test_host : config.main_host;
    state = {
        table_key: 'tab_channel_table',
        day_channel_count: [], need_show_count: 999,
        day: moment().format('YYYY-MM-DD'), day_channel_type: 'channel', list_loading: false
    };
    ...
    get_day_channel_list({day_tmp='', channel_type='', default_need_show_count=-1}) {
        ...
        fetch(this.main_host + `/v3/operating/day_channel_ranking/?cal_type=user`
    ...
    get_day_channel_charts({day_tmp='', channel_type='', default_need_show_count=-1}) {
        ...
        fetch(this.main_host + `/v3/operating/day_channel_detail/?cal_type=user`
