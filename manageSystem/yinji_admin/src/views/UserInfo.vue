  ...
  methods: {
    ...
    handleSubmit(name) {
      if (this.modalStatus == "create") {
        ...
        var param = this.formatForm();
        //console.log(`http://api.yinji.immusician.com:55555/${process.env.VERSION}/user/update/?god=${param.uid}&phone=${param.phone}`)
        //return
        this.axios
          .get(`http://api.yinji.immusician.com:55555/${process.env.VERSION}/user/admin/update/?uid=${param.uid}&phone=${param.phone}`)
          .then(res => {
