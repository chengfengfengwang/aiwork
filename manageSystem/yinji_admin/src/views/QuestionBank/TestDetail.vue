    ...
    <Modal v-model="modalShow" width="1260">
      ...
      <div class="modal_bank_wrapper">
        ...
        <div class="right">
          ...
          <div v-if="showType==2">
            <div v-for="(type2,index) in type2Arr" :key="type2.question_id" class="item_wrapper">
          ...
          <div v-if="showType==3">
            <div v-for="(type3,index) in type3Arr" :key="type3.question_id" class="item_wrapper">
          ...
          <div v-if="showType==4">
            <div v-for="(type4,index) in type4Arr" :key="type4.question_id" class="item_wrapper">
