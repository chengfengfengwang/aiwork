            ...
            <div style={{margin: 100}}>
                ...
                <Error2 error={error} onOk={() => this.setState({error: null})}/>
                    ...
                    <FormControl
                        ...
                        {/*<option value='1'>课程付费</option>*/}
                        {/*<option value='2'>课程未付费</option>*/}
                        {/*<option value='3'>题库付费</option>*/}
                        {/*<option value='4'>题库未付费</option>*/}
                        {/*<option value='5'>所有付费</option>*/}
                        {/*<option value='6'>所有未付费用户</option>*/}
                        {/*{(function () {*/}
                        {/*if (linktype === '6') {*/}
                        {/*return (*/}
