...
export default {
  ...
  methods: {
    handleUpload(file) {
      ...
      //return false
      this.axios
        .post(`${process.env.XIAOPO}/v2/upload_material/`, formdata, {
          headers: {
    ...
    getTableData() {
      ...
      this.axios
        .get(
          `${process.env.JINKANG}/v2/ranking/game_list/`
        )
        .then(res => {
    ...
    delete(id) {
      this.axios
        .get(process.env.XIAOPO + "/v2/new_question/deleted/?_id=" + id)
        .then(res => {
          this.getTableData();
        });
    },
    ...
    handleSubmit(name) {
      if (this.modalStatus == "create") {
        ...
        //return
        this.axios
          .post(process.env.XIAOPO + "/v2/new_question/create/", param)
          .then(res => {
        ...
        //return
        this.axios
          .post(process.env.XIAOPO + "/v2/new_question/update/", param)
          .then(res => {
