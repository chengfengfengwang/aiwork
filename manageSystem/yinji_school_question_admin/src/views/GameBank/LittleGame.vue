...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      //return;
      this.axios
        .post(process.env.JINKANG + "/v2/mini/games_create/", newForm)
        .then(res => {
    ...
    getGameList() {
      ...
      this.axios
        .get(process.env.JINKANG + "/v2/mini/get_many_games/")
        .then(res => {
    ...
    createCourseGame() {
      var params = {};
      this.axios
        .post(process.env.JINKANG + "/v2/game/create_material/")
        .then(res => {
          //this.tableLoading = false;
          //this.gameList = res.data;
        });
    ...
    remove(row) {
      this.axios
        .get(
          process.env.JINKANG +
            "/v2/mini/delete_games/?mini_game_id=" +
            row.mini_game_id
        )
        .then(res => {
          this.getGameList();
