    ...
    <Modal v-model="modalShow" width="1260">
      ...
      <div>
        <Form ref="formValidate" :model="formValidate" :label-width="100">
          ...
          <!-- 选择游戏配置 -->
          <div v-if="curGame=='xuanze'" style="margin-left:40px">
            <GameCommonSelect
              ref="xuanze"
...
export default {
  ...
  methods: {
    ...
    searchScsykXuanze() {
      ...
      this.axios
        .get(`${process.env.JINKANG}/v2/ranking/get_game/?game_type=25`)
        .then(res => {
    ...
    searchTuozhuai2() {
      this.axios
        .get(
          `${
            process.env.JINKANG
          }/v2/question/get_section_line_data/?question_id=${this.tuozhuai2Id}`
        )
        .then(res => {
          this.$Message.success("查询成功");
          this.tuozhuai2Data = res.data;
    ...
    searchQiaoji() {
      this.axios
        .get(
          `${
            process.env.JINKANG
          }/v2/question/get_section_line_data/?question_id=${this.qiaojiId}`
        )
        .then(res => {
          this.$Message.success("查询成功");
    ...
    getNameList() {
      this.axios
        .get(process.env.XIANSHANG + "/v2/ranking/game_name/")
        .then(res => {
          var obj = res.data;
    ...
    getGameList() {
      ...
      this.axios
        .get(
          `${process.env.JINKANG}/v2/ranking/get_all_game?page=${
            this.page
    ...
    getProductList() {
      this.tableLoading = true;
      this.axios.get(process.env.JINKANG + "/v2/goods/get_goods").then(res => {
        this.tableLoading = false;
        this.gameList = res.data;
      });
    },
    ...
    getProductDetail(id) {
      this.axios.get(process.env.JINKANG + "/v2/goods?id=" + id).then(res => {
        this.tableLoading = false;
        this.getProductList();
      });
    },
    removeGame(id) {
      this.axios
        .get(process.env.JINKANG + "/v2/ranking/delete_game/?game_id=" + id)
        .then(res => {
          this.getGameList();
        });
    },
    ...
    handleSubmit(name) {
      ...
      this.axios
        .post(
          `${process.env.JINKANG}/v2/ranking/create_or_update_game/`,
          formdata
        )
        .then(res => {
