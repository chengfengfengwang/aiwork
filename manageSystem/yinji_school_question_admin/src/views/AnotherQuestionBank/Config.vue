  ...
  methods: {
    ...
    get() {
      ...
      if (this.searchBank === 0) {
        var url = `${process.env.JINKANG}/v2/new_question/get_many/?type=${
          this.type
      ...
      //var url = `${process.env.JINKANG}/v2/new_question/get_many/?type=${this.type}&questionBank=&page=${this.page}&size=${this.pageSize}`;
    ...
    delete(id) {
      this.axios
        .get(process.env.JINKANG + "/v2/new_question/deleted/?_id=" + id)
        .then(res => {
          this.get();
        });
    },
    ...
    handleSubmit(name) {
      if (this.modalStatus == "create") {
        ...
        //return
        this.axios
          .post(process.env.JINKANG + "/v2/new_question/create/", param)
          .then(res => {
        ...
        //return
        this.axios
          .post(process.env.JINKANG + "/v2/new_question/update/", param)
          .then(res => {
    ...
    getQuestionBank() {
      this.tableLoading = true;
      this.axios
        .get(`${process.env.JINKANG}/v2/new_question/list/`)
        .then(res => {
          this.tableLoading = false;
