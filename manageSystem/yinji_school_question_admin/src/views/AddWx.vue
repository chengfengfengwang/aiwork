...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      var url = `${process.env.XIAOPO}/v2/group/buy_group_index/`;
    ...
    getProductDetail(id) {
      this.axios.get(process.env.XIAOPO + "/v2/goods?id=" + id).then(res => {
        this.tableLoading = false;
        this.getTableData();
      });
    },
    delete(id) {
      this.axios
        .get(`${process.env.XIAOPO}/v2/group/deleted_buy_group/${id}/`)
        .then(res => {
          this.getTableData();
        });
    },
    ...
    handleSubmit(name) {
      ...
      if (this.modalStatus == "create") {
        ...
        // return
        this.axios
          .post(process.env.XIAOPO + "/v2/group/buy_group/", formdata, {
          headers: {
...
formdata.append('group_qr', this.group_qr);
        ...
        //return
        this.axios
          .post(`${process.env.XIAOPO}/v2/group/update_buy_group/${this.curId}/`, formdata, {
          headers: {
            "Content-Type": "multipart/form-data"
            }
            })
    ...
    getGoodsList() {
      this.axios
        .get(`http://58.87.125.111:55555/v2/goods/get_goods?page=0&size=999`)
        .then(res => {
