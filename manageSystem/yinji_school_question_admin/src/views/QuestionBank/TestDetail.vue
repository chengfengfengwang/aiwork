...
export default {
  ...
  methods: {
    changeOrder(){
      ...
      this.axios
        .get(
          `${process.env.JINKANG}/v2/mock/create/?update_ids=1&mock_id=${this.mock_id}&ids=${changeIds}`
        )
        .then(res => {
          this.getCurQuestionBank()
        });
    ...
    getCurQuestionBank() {
      this.axios
        .get(
          `${process.env.JINKANG}/v2/mock/get_mock/?mock_id=${
            this.mock_id
    ...
    submit(params) {
      ...
      this.axios
        .post(`${process.env.JINKANG}/v2/mock/create/`, params)
        .then(res => {
    ...
    getAllTypeArr() {
      this.axios
        .get(`${process.env.JINKANG}/v2/question/get_many_material/?source=2&type=${this.curType}&page=${this.page}&size=${this.pageSize}`)
        .then(res => {
