...
export default {
  ...
  methods: {
    ...
    getRangeTimeList() {
      this.axios.get(`${this.baseUrl}/v2/config/get_live_config`).then(res => {
    ...
    removeRoom(id) {
      this.axios
        .get(`${this.baseUrl}/v2/liveroom/delete_room?room_id=${id}`)
        .then(res => {
    ...
    getRoomList(status) {
      ...
      this.axios
        .get(
          `${this.baseUrl}/v2/liveroom/all_rooms?page=${this.page}&size=${
            this.pageSize
    ...
    handleSubmit(name) {
      ...
      //       return
      //       this.axios
      //         .post(`${this.baseUrl}/v2/liveroom/create_room`, formdata,{ headers: {'Content-Type': 'multipart/form-data' }})
      //         .then(res => {
      //           console.log(res);
      //         });
      //     }
      ...
      if (this.modalStatus == "create") {
            var formdata = this.formatForm();
            this.axios
              .post(`${this.baseUrl}/v2/liveroom/create_room`, formdata, {
            ...
            var formdata = this.formatForm();
            this.axios
              .post(`${this.baseUrl}/v2/liveroom/update_room`, formdata, {
                headers: { "Content-Type": "multipart/form-data" }
              })
              .then(res => {
                console.log(res);
