...
const myMenus = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "CourseGameTest", text: "课程游戏配置", link: "/GameBankTest/CourseGameTest" }
    ]
  },
  {
    hasChild: true,
...
export default {
  ...
  created() {
    console.log('created');
    //this.menus = localStorage.getItem('menus')?JSON.parse(localStorage.getItem('menus')):myMenus;
    this.menus = myMenus;
