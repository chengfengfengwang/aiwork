<template>
  <div>
    <div class="table_top_tool" v-show="from=='self'">
    ...
    if(this.from==='self'){
      this.columns = [
        ...
        },
        {
          ...
          key: "message_list",
          render: (h, params) => {
            return h("span", params.row.message_list.map((e)=> e.title).join('-'));
          }
        },
        {
          title: " ",
            ...
            return h("div", [
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.pushMessage(params.row.group_keys);
                    }
                  }
                },
                "推送"
            ...
            return h("div", [
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.$emit('confirm',params.row.group_keys)
                    }
                  }
                },
                "确定添加"
